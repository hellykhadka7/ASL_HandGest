...
import { GestureTextField } from '@/components/GestureTextField';
...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent">
      {/* Header */}
      <header className="border-b border-border/50 bg-background/25 backdrop-blur-xl">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-primary/15 border border-primary/25 backdrop-blur flex items-center justify-center shadow-[var(--shadow-neon)]">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              <GestureTextField
                currentGesture={currentPrediction?.gesture || null}
                isCapturing={isCapturing}
              />
            </motion.div>
      ...
      {/* Footer */}
      <footer className="border-t border-border/50 bg-background/15 backdrop-blur-xl mt-12">
