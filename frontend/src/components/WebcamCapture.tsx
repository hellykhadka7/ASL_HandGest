  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {showLoading && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-card/40 backdrop-blur-md border border-border/50">
            <motion.div
              animate={{ rotate: 360 }}
        ...
        {/* Error state overlay */}
        {showError && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-card/40 backdrop-blur-md border border-border/50 p-8">
            {errorDisplay.icon}
